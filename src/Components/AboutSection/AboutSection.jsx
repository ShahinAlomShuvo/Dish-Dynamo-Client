...
const AboutSection = () => {
  return (
    <div className='bg-[#FFF4EA] relative overflow-hidden'>
      <img className='absolute -top-10 -right-10 ' src={iconBg} alt='' />
      <div className='grid grid-cols-2 gap-10 container mx-auto my-20 py-10'>
        <img src={about} alt='' />
        <div className='pt-16 space-y-6'>
          ...
          <ul className='grid grid-cols-2 gap-6'>
            <li className='flex gap-2 items-center text-[17px]'>
